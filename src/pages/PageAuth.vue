  ...
  methods: {
    ...
    reRouter() {
      ...
      if (
        ...
        window.history.state.back != this.$myvar.router.auth.url
      ) {
        this.$router.back();
      } else {
